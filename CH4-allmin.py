...
#######                                          #########
#######                                          #########
fileEnergy = open("allminNEWCH4energies.txt", "a+")
fileXYZ = open("allminNEWCH4ancestors.xyz", "a+")
fileneg = open("allminNEWCH4neg.xyz", "a+")
timestep = 0
energies = []
population = []
ancestorPile = []
...
for c in range(0,cycles):    
	...
	for x in xrange(0,len(potentials)):
		if potentials[x]<0:
			fileneg.write(potentials[x])
			fileneg.write("\n")
			fileneg.write(whereUat[x])
			fileneg.write("\n\n")
