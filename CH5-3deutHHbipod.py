...
#######                                          #########
#######                                          #########
#fileEnergy = open("3deut_energies8.txt", "a+")
fileXYZ = open("bipodCD3H2x100.xyz", "a+")
...
for c in range(0,cycles):    
	...
	for i in range(0,len(displace)): 
		...
		displace[i,4,:] = np.random.normal(0,sigma3,(1,3))
		displace[i,5,:] = np.random.normal(0,sigma3,(1,3))
	...
	if timestep%500 == 50 and timestep > 50:
		for i in whereUfrom:
